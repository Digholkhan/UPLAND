          ...
          {showModal ? (
                <>
                  <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-white ">
                    <div className="bg-PopUp bg-cover bg-center p-20 w-auto lg:w-[731px] h-auto lg:h-[800px] mx-auto ">
                        <div className="sm:pl-36">
                          <Heading className='text-[40px] lg:!text-[50px]  mx-auto font-semibold text-white pb-[40px] pt-3 lg:text-start text-center'>Get a free trial for <span className='text-primary'>30</span> days</Heading>
                          <p className='text-white w-[300px] lg:w-[400px] xl:text-start text-center'>Culpa non ex tempor qui nulla laborum. Laboris culpa ea incididunt dolore ipsum tempor duis do ullamc.</p>
                          <div className='grid justify-start'>
                            <input type="text" placeholder='Name'  className='!w-[300px] lg:!w-[400px] !my-8 !py-1 !border-2 !border-solid !border-secondary !bg-white !text-secondary !rounded-full !pl-5 !mb-0'/>
                            <input type="text" placeholder='Email'  className='!w-[300px] lg:!w-[400px] !my-8 !py-1 !border-2 !border-solid !border-secondary  !bg-white !text-secondary !rounded-full !pl-5 !mb-0'/>
                            <input type="text" placeholder='Message'  className='!w-[300px] lg:!w-[400px]  !my-8 !py-1 !border-2 !border-solid !border-secondary  !bg-white  !text-secondary !rounded-[20px] !pl-5 !mb-0  !pb-24'/>
                          </div>
